...
package com.chert.inputmethod.latin.settings;
...
import com.chert.inputmethod.latin.accounts.AccountStateChangedListener;
import com.chert.inputmethod.latin.accounts.LoginAccountUtils;
import com.chert.inputmethod.latin.define.ProductionFlags;
import com.chert.inputmethod.latin.permissions.PermissionsUtil;
import com.chert.inputmethod.latin.utils.ManagedProfileUtils;
...
public final class AccountsSettingsFragment extends SubScreenFragment {
    ...
    boolean isSyncEnabled() {
        return getSharedPreferences().getBoolean(LocalSettingsConstants.PREF_ENABLE_CLOUD_SYNC, false);
    }
